      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-8">
          ...
          <div className="inline-flex items-center gap-2 rounded-full border border-purple-500/30 bg-purple-500/10 px-4 py-2 backdrop-blur-sm">
            ...
            <span className="text-sm text-purple-200">On-chain gameplay • Mantle Network powered</span>
          </div>
          ...
          <div className="space-y-6">
            ...
            <p className="text-xl text-white/60 max-w-2xl leading-relaxed">
              ...
              Mantle Network. Prove your mastery. Claim your legacy.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-8">
            ...
            >
              {isConnecting ? "Connecting Wallet..." : isConnected ? "Start Playing Now" : "Chainmate"}
